<template>
    <form @submit.prevent="handleSubmit">
        ...
        <label>Email:</label>
        <input type="email" placeholder="Enter email here" required v-model="email">
        ...
        <input type="password" placeholder="Enter again password" required v-model="confirmpassword">
